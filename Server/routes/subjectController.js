...
module.exports = (app) => {
    ...
    app.put('/subjects/deactivate/:id', ensureAuthenticated, checkIfAdmin, (req, res) => {
        subjectService.deactivateById(req.params.id).then(() => {
    ...
    app.post('/subjects/new', ensureAuthenticated, checkIfAdmin, (req, res) => {
        subjectService.addNewSubejct(req.body.name).then(() => {
