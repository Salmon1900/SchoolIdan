...
const addNewStudent = async (student) => {
    ...
    let studentValidation = newStudentValid({id: student.id, name: student.name, birthYear: student.birthYear});
    ...
    return querySchoolDB(qry.addStudent, [student.id, student.name, student.birthYear]);
}
